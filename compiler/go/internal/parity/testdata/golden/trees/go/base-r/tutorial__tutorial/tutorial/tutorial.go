...
import (
	...
	"github.com/apache/thrift/lib/go/test/gopath/src/shared"
)
...
func (p Operation) String() string {
	...
	return fmt.Sprintf("Operation(%d)", p)
}
...
func (p Operation) IsDefined() bool {
	switch p {
	case Operation_ADD:
		return true
	case Operation_SUBTRACT:
...
//go:fix inline
func OperationPtr(v Operation) *Operation { return new(v) }
...
//go:fix inline
func MyIntegerPtr(v MyInteger) *MyInteger { return new(v) }

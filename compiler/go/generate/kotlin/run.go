...
// THRIFT_REGISTER_GENERATOR(kotlin, "Kotlin", "") registers no options at
// all: the third argument, the option doc string, is empty.
func init() {
...
// runner is the registry's view of one parsed --gen kotlin argument.
...
// main.cc restricted to the Kotlin generator.
